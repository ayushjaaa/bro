...
async function main() {
  ...
  await page.screenshot({ path: path.join(OUT_DIR, 'r1-rolling-papers-filters.png'), fullPage: true });

  const text = await page.evaluate(() => document.body.innerText);
  for (const label of ['Paper Size', 'Material', 'Paper Type', 'Length / Width', 'Pack Quantity']) {
